...
class Tours_InfoSiteHelper
{
	...
	*/
	...
	static function setDocument( $title = '', $metaDesc = '', $metaKey = '' )
	{
		...
		$doc->addScript( $baseUrl . 'components/com_tours_info/assets/scripts/tours_info.js' )
			->addStyleSheet( $baseUrl . 'components/com_tours_info/assets/styles/tours_info.css' );
